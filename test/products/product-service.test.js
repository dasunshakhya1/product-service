...
import * as productRepo from "../../src/products/product-repository.js";
import * as productService from "../../src/products/product-service.js";
...
describe("Verify product service", () => {
  ...
  it("Verify getProductById should return 404 when product is not found by productId", async () => {
    jest.spyOn(productRepo, "getProductByIdDB").mockReturnValueOnce(undefined);
